  ...
  return (
    ...
    <div className="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul className="navbar-nav">
        ...
        <li className="nav-item">
          <a className="nav-link  " href="/Home/add">
            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span className="nav-link-text ms-1">Ajouter Categorie</span>
          </a>
        </li>
        <li className="nav-item">
          <a className="nav-link  " href="/Home/list">
            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            ...
            <span className="nav-link-text ms-1">Liste des Categories</span>
          </a>
        </li>        
        <li className="nav-item">
          <a className="nav-link  " href="/Home/listA">
            ...
            <span className="nav-link-text ms-1">Liste des Annonces</span>
          </a>
        </li>        
        <li className="nav-item">
          <a className="nav-link  " href="/Home/listCl">
            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                <title>box-3d-50</title>
                <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
            ...
            <span className="nav-link-text ms-1">Liste des Clients</span>
          </a>
        </li>        
        <li className="nav-item">
          <a className="nav-link  " href="/Home/listV">
            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                <title>box-3d-50</title>
                <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
            ...
            <span className="nav-link-text ms-1">Liste des Vendeurs</span>
          </a>
        </li>
        <li className="nav-item">
          <a className="nav-link  " href="/Home/listC">
            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                <title>box-3d-50</title>
                <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
            ...
            <span className="nav-link-text ms-1">Liste des Commentaires</span>
          </a>
        </li>
